Jeremias: Sources/Main.cpp Allegro.o Janela.o Imagem.o Fonte.o Jogo.o Mouse.o Personagem.o Anime.o Teclado.o
	g++ -std=c++11 -o Jeremias Sources/Main.cpp Allegro.o Janela.o Imagem.o Fonte.o Mouse.o Jogo.o Teclado.o Personagem.o Anime.o -lallegro -lallegro_image -lallegro_font -lallegro_ttf
